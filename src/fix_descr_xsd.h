...
"      <xs:restriction base='xs:string'>"
"         <xs:pattern value='String|Length|Amt|Price|Char|Int|Currency|NumInGroup|LocalMktDate|Percentage|Boolean|MonthYear|Qty|Float|PriceOffset|UTCTimestamp|SeqNum|Data|Exchange|Country|MultipleValueString|UTCTimeOnly|UTCDateOnly|DayOfMonth|TZTimeOnly|TZTimestamp|XMLData|Language'/>"
"      </xs:restriction>"
"   </xs:simpleType>"
""
"   <xs:element name='fix'>"
...
"            </xs:element>"
"         </xs:sequence>"
"         <xs:attribute name='version' type='FIXVersion' use='required'/>"
"      </xs:complexType>"
"   </xs:element>"
"</xs:schema>"
};
